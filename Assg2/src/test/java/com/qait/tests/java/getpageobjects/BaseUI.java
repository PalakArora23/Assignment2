...
import static com.qait.tests.java.getpageobjects.ObjectFileReader.getPageTitleFromFile;
...
import com.qait.tests.java.utils.SeleniumWait;
...
public class BaseUI {
	...
	protected void scrollToTrendingSection() {
		((JavascriptExecutor) driver).executeScript("window.scrollBy(0,3400)");
	}
	//1500
	protected void scrollToEditorChoice() {
	...
	public Double videoCurrentTime() {
		return (Double) executeJavascript("return document.getElementsByTagName('video')[0].currentTime");
	}
	public void videoPlay() {
		executeJavascript("document.getElementsByTagName('video')[0].play()");
	}
	public void videoPause() {
		executeJavascript("document.getElementsByTagName('video')[0].pause()");
	}
	
	public Boolean verifyVideoPaused() {
		return (Boolean) executeJavascript("return document.getElementsByTagName('video')[0].paused");
	}

	public String getBackgroundURL() {
		return (String) executeJavascript("return window.getComputedStyle(document.querySelector('.hero-image')).backgroundImage;");		
	}
